...
import com.softechurecab.app.ui.activity.WelcomeActivityNew;
import com.softechurecab.app.ui.activity.login.EmailActivity;
import com.softechurecab.app.ui.activity.login.PasswordActivity;
import com.softechurecab.app.ui.activity.register.RegisterActivity;
import com.softechurecab.app.ui.activity.social.SocialLoginActivity;
import com.softechurecab.app.ui.activity.splash.SplashActivity;
...
public abstract class BaseActivity extends AppCompatActivity
    ...
    private void showOfflineDialog(boolean isConnected, int position) {
        if (!isConnected) if (activity != null) if (position == 0) try {
            final Dialog offlineDialog = new Dialog(this,R.style.AlertDialogCustom);
            ...
            btnSendLocation.setOnClickListener(view -> {
                if (btnSendLocation.getVisibility() == View.VISIBLE) {
                    ...
                    try {
                        ...
                        smsIntent.putExtra("sms_body", " J'ai besoin d'un chauffeur @" + SharedHelper.getKey(baseActivity(), "latitude") + "," + SharedHelper.getKey(baseActivity(), "longitude") + "( Veuillez ne pas modifier ce SMS)");
            ...
            e.printStackTrace();
                ...
                offlineDialog = new Dialog(this,R.style.AlertDialogCustom);
                offlineDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                offlineDialog.setCancelable(false);
                offlineDialog.setCanceledOnTouchOutside(false);
    ...
    public String getNameResult(Name value){
        ...
        String language=  SharedHelper.getKey(getApplicationContext(),"lang_code","en");
    ...
    protected void shareApp(String shareLink) {
        try {
...
//                            Toasty.error(this, getString(R.string.internal_server_error), Toast.LENGTH_SHORT).show();
    ...
    public void timePicker(TimePickerDialog.OnTimeSetListener timeSetListener) {
        ...
        TimePickerDialog mTimePicker = new TimePickerDialog(this,R.style.AlertDialogCustom, timeSetListener, myCalendar.get(Calendar.HOUR_OF_DAY), myCalendar.get(Calendar.MINUTE), true);
        mTimePicker.show();
    }
