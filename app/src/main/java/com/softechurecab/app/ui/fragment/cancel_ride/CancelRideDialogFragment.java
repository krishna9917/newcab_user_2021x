...
import com.softechurecab.app.base.BaseBottomSheetDialogFragment;
...
import static com.softechurecab.app.MvpApplication.cancelCharge;
...
public class CancelRideDialogFragment extends BaseBottomSheetDialogFragment implements CancelRideIView {
    ...
    public void initView(View view) {
        ...
        if(cancelCharge != 0){
            ...
            cancelNote.setText( String.format(getString(R.string.cancel_charge_note) + SharedHelper.getKey(getContext(), "currency") + " " +cancelCharge));
        }
