...
import com.softechurecab.app.ui.activity.past_trip_detail.PastTripDetailActivity;
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            Glide.with(Objects.requireNonNull(getActivity()))
                    ...
                    .apply(RequestOptions.placeholderOf(R.drawable.backride)
                            .dontAnimate().
                                    error(R.drawable.backride).diskCacheStrategy(DiskCacheStrategy.ALL))
                    .into(holder.staticMap);

            ServiceType mService = datum.getServiceType();
            if (mService != null) {
                holder.serviceType.setText(getNameResult(mService.getName()));
                Glide.with(baseActivity())
                        .load(BuildConfig.BASE_IMAGE_URL+mService.getImage())
