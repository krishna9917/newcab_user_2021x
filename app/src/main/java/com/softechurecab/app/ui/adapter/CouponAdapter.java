    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (promoList != null) {
            ...
            if (couponPosition != promoList.getId())
                ...
                {
                    holder.promoStatus.setText(context.getString(R.string.use));
                    holder.promoStatus.setTextColor(context.getColor(R.color.colorPrimaryDark));
                }
                else
                {
                    holder.promoStatus.setTextColor(context.getColor(R.color.colorAccent));
                    holder.promoStatus.setText(context.getString(R.string.remove));
                }
